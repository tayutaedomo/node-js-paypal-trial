...
router.get('/checkout', function(req, res, next) {
  res.render('reference_transactions/checkout', {
...
router.get('/agreement', function(req, res, next) {
  res.render('reference_transactions/agreement', {
...
router.get('/transaction', function(req, res, next) {
  res.render('reference_transactions/transaction', {
...
router.get('/void', function(req, res, next) {
  res.render('reference_transactions/void', {
    title: 'Void Order',
    error: {},
    data: {}
  });
